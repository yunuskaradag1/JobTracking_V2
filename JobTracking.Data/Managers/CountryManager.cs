...
{
    public class CountryManager : BaseManager<Country, CountryRepository, MainDbContext>
    {
    ...
    : base(repository)
        ...
        public override async Task<Country> Update(Country entity)
        {
        ...
        public override async Task<Country> Insert(Country entity)
        {
            using (var transaction = repository.Context.Database.BeginTransaction())
            {
                try
